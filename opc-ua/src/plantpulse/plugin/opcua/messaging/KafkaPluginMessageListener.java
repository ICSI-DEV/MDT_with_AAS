...
import plantpulse.plugin.opcua.utils.PropertiesUtils;
...
public class KafkaPluginMessageListener extends PluginMessageProcessor implements PluginMessageListener {
	...
	public KafkaPluginMessageListener(PlantPulseNamespace namespace) {
		super(namespace);
	}
	...
	public void startListener() {
		try {
			...
			for (int i = 0; i < thread; i++) {
				KafkaPluginMessageConsumerThread consumer = new KafkaPluginMessageConsumerThread(getNamespace(), props, topic);
