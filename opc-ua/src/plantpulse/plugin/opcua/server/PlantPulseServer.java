...
public class PlantPulseServer {

	private static final Log log = LogFactory.getLog(PlantPulseServer.class);
	
    public static final int TCP_BIND_PORT = 12686;
    public static final int HTTPS_BIND_PORT = 8443;
    ...
    public static void main(String[] args) throws Exception {
        PlantPulseServer server = new PlantPulseServer();
    ...
    private final PlantPulseNamespace ppNamespace;

    public PlantPulseServer() throws Exception {
        ...
        boolean flag = false;
        if(ConstantsJSON.getConfig().containsKey("opc.ua.server.ananymous")){
        	flag = ConstantsJSON.getConfig().getBoolean("opc.ua.server.ananymous");
        };
        ...
        UsernameIdentityValidator identityValidator = new UsernameIdentityValidator(
            ...
            authChallenge -> {
                ...
                boolean userOk = ConstantsJSON.getConfig().getString("opc.ua.server.user").equals(username)
                		&& ConstantsJSON.getConfig().getString("opc.ua.server.password").equals(password);
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
            ...
            .setApplicationName(LocalizedText.english("PlantPulse OPC-UA Server"))
            .setEndpoints(endpointConfigurations)
            .setBuildInfo(
                new BuildInfo(
                    "urn:plantpulse:opcua:server",
                    "plantpulse",
                    "plantpulse opcua server",
            ...
            .setProductUri("urn:plantpulse:opcua:server")
            .build();
        ...
        ppNamespace = new PlantPulseNamespace(server);
        ppNamespace.startup();
    }
