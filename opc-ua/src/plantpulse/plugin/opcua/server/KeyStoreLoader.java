...
class KeyStoreLoader {
    ...
    KeyStoreLoader load(File baseDir) throws Exception {
        ...
        File serverKeyStore = baseDir.toPath().resolve("plantpulse-server.pfx").toFile();
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = "urn:plantpulse:opcua:server:" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                .setCommonName("PlantPulse OPC-UA Server")
                .setOrganization("KOPENS")
                .setOrganizationalUnit("DEV")
                .setLocalityName("CHNAGWON")
                .setStateName("KN")
                .setCountryCode("KR")
