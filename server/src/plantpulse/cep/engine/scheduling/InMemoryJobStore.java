...
public class InMemoryJobStore implements JobStore {
    ...
    /**
     * <p>
     * Create a new <code>InMemoryJobStore</code>.
     * </p>
     */
    ...
    public void initialize(ClassLoadHelper loadHelper, SchedulerSignaler schedSignaler) {
        ...
        getLog().info("InMemoryJobStore initialized.");
    }
    ...
    public void triggeredJobComplete(OperableTrigger trigger,
        ...
        synchronized (lock) {
            ...
            //   2- InMemoryJobStore is being used only for volatile jobs / triggers
	...
	@Override
	public long getAcquireRetryDelay(int arg0) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public void resetTriggerFromErrorState(TriggerKey arg0) throws JobPersistenceException {
		// TODO Auto-generated method stub
