 ...
 *
 */
public class VersionUpdate_V6_0_1_20181012 implements VersionUpdate {

	private static final Log log = LogFactory.getLog(VersionUpdate_V6_0_1_20181012.class);
	...
	public void upgrade() throws Exception {
		...
		try {
			...
			run.update(conn, " ALTER TABLE PUBLIC.MM_OPCS ADD OPC_SUB_TYPE VARCHAR(100); ");
			
			//
			run.update(conn, " CHECKPOINT; ");

		}catch(Exception ex) {
			log.error("VersionUpdate_V6_0_1_20181012 - HSQLDB 업그레이드 에러 : " + ex.getMessage(), ex);
		}finally {
